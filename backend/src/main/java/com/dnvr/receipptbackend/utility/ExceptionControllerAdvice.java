package com.dnvr.receipptbackend.utility;
...
public class ExceptionControllerAdvice {
	...
	@ExceptionHandler(ReceipptException.class)
    public ResponseEntity<ErrorInfo> receipptExceptionHandler(ReceipptException exception)
    {
	...
	errorInfo.setErrorMessage(env.getProperty("general.error"));
